# Tree Height — Lesson 99

**Origin:** Codility &nbsp;|&nbsp; **Topics:** Graph, Recursion / Backtracking

*Source:* `Codility/Lessons/Lesson99/TreeHeight.java`
...
a single integer value and two further binary trees, called the left subtree and the right subtree.
...
respectively. The right subtree of the node containing the value 10,
...
An empty binary tree is denoted by None. A non-empty tree is denoted as (X, L, R),
where X is the value contained in the root and L and R denote the left and right subtrees, respectively.
...
public class TreeHeight {
	...
	// https://codility.com/demo/results/demoNSAXXF-CXA/
