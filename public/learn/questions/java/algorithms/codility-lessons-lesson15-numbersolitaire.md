# Number Solitaire — Lesson 15

**Origin:** Codility &nbsp;|&nbsp; **Topics:** Dynamic Programming

*Source:* `Codility/Lessons/Lesson15/NumberSolitaire.java`
...
public class NumberSolitaire {
    // https://codility.com/demo/results/demoDAM6G9-ZTQ/
