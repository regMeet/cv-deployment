# Frog River One — Lesson 2

**Origin:** Codility &nbsp;|&nbsp; **Topics:** Hash Set, Arrays

*Source:* `Codility/Lessons/Lesson2/FrogRiverOne.java`
...
//				count++;
	...
	// hash.size() could be the count
	public int solution3(int X, int[] A) {
		int n = A.length;
		HashSet<Integer> hash = new HashSet<Integer>(X + 1);
		int count = 0;
		for (int i = 0; i < n; i++) {
	...
	public static void main(String[] args) {
		int ans = new FrogRiverOne().solution3(5, new int[] { 1, 3, 1, 4, 2, 3, 5, 4 });
